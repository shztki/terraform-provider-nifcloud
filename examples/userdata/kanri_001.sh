...
IPADDR=192.168.2.1" > /etc/sysconfig/network-scripts/ifcfg-ens192
echo "192.168.3.0/24 via 192.168.2.250
192.168.201.0/24 via 192.168.2.254
10.168.201.0/24 via 192.168.2.245" > /etc/sysconfig/network-scripts/route-ens192
