...
// the plugin provider in this package. See the SDK's example/nifcloud/credential/plugincreds/plugin
...
// credentials loader of a Session or Config. See the SDK's example/nifcloud/credential/plugincreds
// folder for a runnable example of this.
//
