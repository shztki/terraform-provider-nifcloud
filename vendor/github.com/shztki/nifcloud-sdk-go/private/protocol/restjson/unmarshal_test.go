...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *OutputService12ProtocolTest) OutputService12TestCaseOperation1WithContext(ctx nifcloud.Context, input *OutputService12TestShapeOutputService12TestCaseOperation1Input, opts ...request.Option) (*OutputService12TestShapeOutputService12TestCaseOperation3Output, error) {
	req, out := c.OutputService12TestCaseOperation1Request(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
// OutputService12TestCaseOperation2Request generates a "nifcloud/request.Request" representing the
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *OutputService12ProtocolTest) OutputService12TestCaseOperation2WithContext(ctx nifcloud.Context, input *OutputService12TestShapeOutputService12TestCaseOperation2Input, opts ...request.Option) (*OutputService12TestShapeOutputService12TestCaseOperation3Output, error) {
	req, out := c.OutputService12TestCaseOperation2Request(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
// OutputService12TestCaseOperation3Request generates a "nifcloud/request.Request" representing the
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *OutputService12ProtocolTest) OutputService12TestCaseOperation3WithContext(ctx nifcloud.Context, input *OutputService12TestShapeOutputService12TestCaseOperation3Input, opts ...request.Option) (*OutputService12TestShapeOutputService12TestCaseOperation3Output, error) {
	req, out := c.OutputService12TestCaseOperation3Request(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type OutputService12TestShapeOutputService12TestCaseOperation3Output struct {
	...
	BodyField nifcloud.JSONValue `type:"jsonvalue"`

	BodyListField []nifcloud.JSONValue `type:"list"`

	HeaderField nifcloud.JSONValue `location:"header" locationName:"X-Amz-Foo" type:"jsonvalue"`
}

// SetBodyField sets the BodyField field's value.
func (s *OutputService12TestShapeOutputService12TestCaseOperation3Output) SetBodyField(v nifcloud.JSONValue) *OutputService12TestShapeOutputService12TestCaseOperation3Output {
	s.BodyField = v
	return s
}

// SetBodyListField sets the BodyListField field's value.
func (s *OutputService12TestShapeOutputService12TestCaseOperation3Output) SetBodyListField(v []nifcloud.JSONValue) *OutputService12TestShapeOutputService12TestCaseOperation3Output {
	s.BodyListField = v
	return s
}

// SetHeaderField sets the HeaderField field's value.
func (s *OutputService12TestShapeOutputService12TestCaseOperation3Output) SetHeaderField(v nifcloud.JSONValue) *OutputService12TestShapeOutputService12TestCaseOperation3Output {
	s.HeaderField = v
	return s
}
