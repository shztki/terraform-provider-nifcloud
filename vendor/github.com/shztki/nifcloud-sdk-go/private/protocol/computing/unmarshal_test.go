...
type OutputService10TestShapeOutputService10TestCaseOperation1Output struct {
	...
	FooEnum *string `type:"string" enum:"OutputService10TestShapeCOMPUTINGEnumType"`
...
const (
	// COMPUTINGEnumTypeFoo is a OutputService10TestShapeCOMPUTINGEnumType enum value
	COMPUTINGEnumTypeFoo = "foo"

	// COMPUTINGEnumTypeBar is a OutputService10TestShapeCOMPUTINGEnumType enum value
	COMPUTINGEnumTypeBar = "bar"
)
...
func TestOutputService1ProtocolTestScalarMembersCase1(t *testing.T) {
	...
	// unmarshal response
	computing.UnmarshalMeta(req)
	computing.Unmarshal(req)
	if req.Error != nil {
