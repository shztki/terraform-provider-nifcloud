...
#  name        = var.firewallgroup_example_web["name"]
#  description = var.firewallgroup_example_web["memo"]
#}
...
#  name        = var.firewallgroup_example_db["name"]
#  description = var.firewallgroup_example_db["memo"]
#}
...
resource "nifcloud_securitygroup" "example_firewallgroup_003" {
  name                   = var.firewallgroup_example_vpn1["name"]
  description            = var.firewallgroup_example_vpn1["memo"]
  group_log_limit_update = var.firewallgroup_example_vpn1["log_limit"]
}
resource "nifcloud_securitygroup_rule" "example_firewallgroup_003_rule_001" {
  ...
  rules {
    ...
    #to_port         = 80
    protocol    = "ANY"
    cidr_blocks = var.customer_gateway_001["ip_address"]
    #security_groups = nifcloud_securitygroup.example_firewallgroup_001.name
    description = "for vpn"
    inout       = "IN"
  }
...
resource "nifcloud_securitygroup" "example_firewallgroup_004" {
  name                   = var.firewallgroup_example_web1["name"]
  description            = var.firewallgroup_example_web1["memo"]
  group_log_limit_update = var.firewallgroup_example_web1["log_limit"]
}
...
resource "nifcloud_securitygroup" "example_firewallgroup_005" {
  name                   = var.firewallgroup_example_db1["name"]
  description            = var.firewallgroup_example_db1["memo"]
  group_log_limit_update = var.firewallgroup_example_db1["log_limit"]
}
...
resource "nifcloud_securitygroup" "example_firewallgroup_006" {
  name                   = var.firewallgroup_example_kanri1["name"]
  description            = var.firewallgroup_example_kanri1["memo"]
  group_log_limit_update = var.firewallgroup_example_kanri1["log_limit"]
}
