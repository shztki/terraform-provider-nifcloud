resource "nifcloud_lb" "example_lb_web" {
  name            = var.lb_001["name"]
  accounting_type = var.charge_type
  network_volume  = var.lb_001["network_volume"] # 10,20,30,40,100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000
  #ip_version = "v4" # v4,v6
