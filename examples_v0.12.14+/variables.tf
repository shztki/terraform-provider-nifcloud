...
variable "db_001" {
  default = {
    ...
    virtual_address         = "192.168.3.200/24"
    master_address          = "192.168.3.199/24"
    slave_address           = "192.168.3.198/24"

    replica_identifier = "exampledb-replica001"
    replica_address    = "192.168.3.197/24"
...
variable "db_002" {
  default = {
    ...
    #replica_identifier = "exampledb-replica001"
    replica_address = "192.168.3.196/24"
