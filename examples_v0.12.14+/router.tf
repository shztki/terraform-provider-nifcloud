resource "nifcloud_router" "example_router_001" {
  name              = var.router_001["name"]
  router_type       = var.router_001["router_type"]
  ...
  network_interfaces {
    ...
    ipaddress  = var.router_001["ipaddress1"]
    #dhcp            = false
    #dhcp_options_id = ""
    #dhcp_config_id  = ""
  }
